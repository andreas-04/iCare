...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React23.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useOption(params) {
  ...
  const id = useId(idParam);
  const optionRef = React26.useRef(null);
  const selectOption = React26.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useSelect(props) {
  ...
  const options = React29.useMemo(() => {
    if (optionsParam != null) {
      return new Map(optionsParam.map((option, index) => [option.value, {
        value: option.value,
        label: option.label,
        disabled: option.disabled,
        ref: React29.createRef(),
  ...
  const optionValues = React29.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React29.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React29.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React29.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React29.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React29.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React29.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React29.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React29.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const useListParameters = {
    ...
    onHighlightChange: handleHighlightChange,
    onStateChange: handleStateChange,
    reducerActionContext: React29.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const getOptionMetadata = React29.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React29.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function useTabs(parameters) {
  ...
  const onSelected = React34.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React34.useRef(() => void 0);
  const getTabPanelId = React34.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React34.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React34.useCallback((lookupFunction) => {
...
var TabsContext = React35.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React35.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime11.jsx)(TabsContext.Provider, {
...
var _excluded5 = ["children", "value", "defaultValue", "orientation", "direction", "onChange", "selectionFollowsFocus", "slotProps", "slots"];
...
var Tabs = React37.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime12.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime12.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
function useTabPanel(parameters) {
  ...
  const metadata = React38.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React39.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React39.useCallback((tabValue) => {
  ...
  const handleChange = React39.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React39.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React39.useCallback((item) => {
  ...
  const contextValue = React39.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabRef = React41.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React41.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var TextareaAutosize = React42.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React42.Fragment, {
...
var Badge = React43.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime17.jsxs)(Root, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime16.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
var Button = React44.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
var InnerMenuItem = React57.memo(React57.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React57.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime34.jsx)(React64.Fragment, {
...
var Select = React64.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React64.Fragment, {
...
var Slider = React65.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime36.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime36.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime37.jsxs)(React65.Fragment, {
...
init_objectWithoutPropertiesLoose();
init_utils();
var _excluded31 = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"];
...
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded31);
  const {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7TPE75WX.js.map
